...
export default function Profile() {
  ...
  <Grid container justifyContent="space-between" alignItems="center">
    ...
    <Grid item>
      <Button variant="contained" color="primary" onClick={() => router.push("/test")}>Add test</Button>
    </Grid>
  </Grid>
</Paper>
      ...
      <TableCell>
        <Typography sx={{ color: user.status === "Active" ? "green" : "red", fontWeight: 500 }}>{user.status}</Typography>
      </TableCell>
      ...
      <Paper elevation={1} sx={{ p: 3, borderRadius: 3, background: "#fff" }}>
        ...
        <Grid container spacing={2}>
          {[
            ...
            <Grid item key={i}>
              <Button variant="outlined" color={stage.color || "primary"} sx={{ borderRadius: 2 }}>{stage.label}</Button>
            </Grid>
          ))}
        </Grid>
      </Paper>
